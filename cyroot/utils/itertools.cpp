...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "cyroot.utils.itertools"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cyroot__utils__itertools
#define __PYX_HAVE_API__cyroot__utils__itertools
/* Early includes */
#include <string.h>
#include <stdio.h>
...
struct __pyx_opt_args_6cyroot_5utils_9itertools_product_kernel;

/* "cyroot/utils/itertools.pyx":17
 * ]
 * 
...
static int (*__pyx_fuse_0__pyx_f_6cyroot_3ops_10vector_ops_prod)(__Pyx_memviewslice); /*proto*/
...
static __Pyx_memviewslice __pyx_f_6cyroot_5utils_9itertools_product(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE void __pyx_f_6cyroot_5utils_9itertools_product_kernel(__Pyx_memviewslice, __Pyx_memviewslice, struct __pyx_opt_args_6cyroot_5utils_9itertools_product_kernel *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "cyroot.utils.itertools"
extern int __pyx_module_is_main_cyroot__utils__itertools;
int __pyx_module_is_main_cyroot__utils__itertools = 0;

/* Implementation of 'cyroot.utils.itertools' */
...
static PyObject *__pyx_pf_6cyroot_5utils_9itertools_product(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_ns); /* proto */
...
static CYTHON_INLINE void __pyx_f_6cyroot_5utils_9itertools_product_kernel(__Pyx_memviewslice __pyx_v_ns, __Pyx_memviewslice __pyx_v_out, struct __pyx_opt_args_6cyroot_5utils_9itertools_product_kernel *__pyx_optional_args) {
  unsigned int __pyx_v_d = ((unsigned int)0);
  ...
  size_t __pyx_t_8;
  struct __pyx_opt_args_6cyroot_5utils_9itertools_product_kernel __pyx_t_9;
  int __pyx_lineno = 0;
 ...
 */
  __pyx_t_1 = ((__pyx_v_d >= (__pyx_v_ns.shape[0])) != 0);
  if (__pyx_t_1) {

    /* "cyroot/utils/itertools.pyx":22
 *         unsigned int d=0) nogil:
 *     if d >= ns.shape[0]:
 *         return             # <<<<<<<<<<<<<<
 *     cdef unsigned int n = ns[d]
 ...
 */
  __pyx_t_2 = __pyx_v_d;
  __pyx_v_n = (*((unsigned int *) ( /* dim=0 */ (__pyx_v_ns.data + __pyx_t_2 * __pyx_v_ns.strides[0]) )));

  /* "cyroot/utils/itertools.pyx":24
 *         return
 *     cdef unsigned int n = ns[d]
 *     cdef unsigned int step = vector_ops.prod[np.uint32_t](ns[d + 1:])             # <<<<<<<<<<<<<<
 *     cdef unsigned int i
 ...
 */
  __pyx_t_3.data = __pyx_v_ns.data;
  __pyx_t_3.memview = __pyx_v_ns.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_3, 0);
  __pyx_t_4 = -1;
  if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_3,
    __pyx_v_ns.shape[0], __pyx_v_ns.strides[0], __pyx_v_ns.suboffsets[0],
    0,
    0,
    &__pyx_t_4,
    (__pyx_v_d + 1),
...
__pyx_v_step = __pyx_fuse_1__pyx_f_6cyroot_3ops_10vector_ops_prod(__pyx_t_3);
  __PYX_XDEC_MEMVIEW(&__pyx_t_3, 0);
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "cyroot/utils/itertools.pyx":26
 *     cdef unsigned int step = vector_ops.prod[np.uint32_t](ns[d + 1:])
 *     cdef unsigned int i
 *     for i in range(out.shape[0]):             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_2 = __pyx_v_i;
    __pyx_t_8 = __pyx_v_d;
    *((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out.data + __pyx_t_2 * __pyx_v_out.strides[0]) ) + __pyx_t_8 * __pyx_v_out.strides[1]) )) = (((unsigned int)(__pyx_v_i / __pyx_v_step)) % __pyx_v_n);
  }

  /* "cyroot/utils/itertools.pyx":28
 *     for i in range(out.shape[0]):
 *         out[i, d] = <unsigned int> (i / step) % n
 *     product_kernel(ns, out, d + 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_9.__pyx_n = 1;
  __pyx_t_9.d = (__pyx_v_d + 1);
  __pyx_f_6cyroot_5utils_9itertools_product_kernel(__pyx_v_ns, __pyx_v_out, &__pyx_t_9); 
 ...
 */
  ...
  __pyx_L1_error:;
  __PYX_XDEC_MEMVIEW(&__pyx_t_3, 0);
  __Pyx_WriteUnraisable("cyroot.utils.itertools.product_kernel", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "cyroot/utils/itertools.pyx":30
 *     product_kernel(ns, out, d + 1)
 * 
 * cpdef unsigned int[:, :] product(unsigned int[:] ns):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_6cyroot_5utils_9itertools_1product(PyObject *__pyx_self, PyObject *__pyx_arg_ns); /*proto*/
static __Pyx_memviewslice __pyx_f_6cyroot_5utils_9itertools_product(__Pyx_memviewslice __pyx_v_ns, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyArrayObject *__pyx_v_empty = 0;
  unsigned int __pyx_v_i;
  __Pyx_memviewslice __pyx_v_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_LocalBuf_ND __pyx_pybuffernd_empty;
  __Pyx_Buffer __pyx_pybuffer_empty;
  ...
  struct __pyx_opt_args_6cyroot_5utils_9itertools_product_kernel __pyx_t_12;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("product", 0);
  __pyx_pybuffer_empty.pybuffer.buf = NULL;
  __pyx_pybuffer_empty.refcount = 0;
  __pyx_pybuffernd_empty.data = NULL;
  __pyx_pybuffernd_empty.rcbuffer = &__pyx_pybuffer_empty;

  /* "cyroot/utils/itertools.pyx":31
 * 
 * cpdef unsigned int[:, :] product(unsigned int[:] ns):
 *     cdef np.ndarray[np.uint32_t, ndim=2] empty = np.empty((0, 0), dtype=np.uint32)             # <<<<<<<<<<<<<<
 *     cdef unsigned int i
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_uint32); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 31, __pyx_L1_error)
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_empty.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_empty = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_empty.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 31, __pyx_L1_error)
    } else {__pyx_pybuffernd_empty.diminfo[0].strides = __pyx_pybuffernd_empty.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_empty.diminfo[0].shape = __pyx_pybuffernd_empty.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_empty.diminfo[1].strides = __pyx_pybuffernd_empty.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_empty.diminfo[1].shape = __pyx_pybuffernd_empty.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_5 = 0;
  __pyx_v_empty = ((PyArrayObject *)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "cyroot/utils/itertools.pyx":33
 *     cdef np.ndarray[np.uint32_t, ndim=2] empty = np.empty((0, 0), dtype=np.uint32)
 *     cdef unsigned int i
 *     for i in range(ns.shape[0]):             # <<<<<<<<<<<<<<
 *         if ns[i] == 0:
 *             return empty
 */
  __pyx_t_6 = (__pyx_v_ns.shape[0]);
  __pyx_t_7 = __pyx_t_6;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "cyroot/utils/itertools.pyx":34
 *     cdef unsigned int i
 *     for i in range(ns.shape[0]):
 *         if ns[i] == 0:             # <<<<<<<<<<<<<<
 *             return empty
 ...
 */
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_10 = (((*((unsigned int *) ( /* dim=0 */ (__pyx_v_ns.data + __pyx_t_9 * __pyx_v_ns.strides[0]) ))) == 0) != 0);
    if (__pyx_t_10) {

      /* "cyroot/utils/itertools.pyx":35
 *     for i in range(ns.shape[0]):
 *         if ns[i] == 0:
 *             return empty             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_int(((PyObject *)__pyx_v_empty), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 35, __pyx_L1_error)
      __pyx_r = __pyx_t_11;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_fuse_1__pyx_f_6cyroot_3ops_10vector_ops_prod(__pyx_v_ns)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyInt_FromSsize_t((__pyx_v_ns.shape[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_shape, __pyx_t_3) < 0) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "cyroot/utils/itertools.pyx":39
 *     cdef unsigned int[:, :] out = view.array(
 *         shape=(vector_ops.prod[np.uint32_t](ns), ns.shape[0]),
 *         itemsize=sizeof(int),             # <<<<<<<<<<<<<<
 *         format='I')
 ...
 */
  __pyx_t_3 = __Pyx_PyInt_FromSize_t((sizeof(int))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_itemsize, __pyx_t_3) < 0) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_format, __pyx_n_u_I) < 0) __PYX_ERR(0, 38, __pyx_L1_error)

  /* "cyroot/utils/itertools.pyx":37
 *             return empty
 * 
 *     cdef unsigned int[:, :] out = view.array(             # <<<<<<<<<<<<<<
 *         shape=(vector_ops.prod[np.uint32_t](ns), ns.shape[0]),
 *         itemsize=sizeof(int),
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_int(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_out = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "cyroot/utils/itertools.pyx":41
 *         itemsize=sizeof(int),
 *         format='I')
 *     product_kernel(ns, out, 0)             # <<<<<<<<<<<<<<
 *     return out
 */
  ...
  __pyx_t_12.d = 0;
  __pyx_f_6cyroot_5utils_9itertools_product_kernel(__pyx_v_ns, __pyx_v_out, &__pyx_t_12); 

  /* "cyroot/utils/itertools.pyx":42
 *         format='I')
 *     product_kernel(ns, out, 0)
 *     return out             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_empty.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("cyroot.utils.itertools.product", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_empty.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_6cyroot_5utils_9itertools_1product(PyObject *__pyx_self, PyObject *__pyx_arg_ns); /*proto*/
static PyObject *__pyx_pw_6cyroot_5utils_9itertools_1product(PyObject *__pyx_self, PyObject *__pyx_arg_ns) {
  ...
  assert(__pyx_arg_ns); {
    __pyx_v_ns = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_int(__pyx_arg_ns, PyBUF_WRITABLE); if (unlikely(!__pyx_v_ns.memview)) __PYX_ERR(0, 30, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_6cyroot_5utils_9itertools_product(__pyx_self, __pyx_v_ns);
...
static PyObject *__pyx_pf_6cyroot_5utils_9itertools_product(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_ns) {
  ...
  __pyx_t_1 = __pyx_f_6cyroot_5utils_9itertools_product(__pyx_v_ns, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 30, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_int, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_int, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cyroot.utils.itertools.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cyroot.utils.itertools.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cyroot.utils.itertools.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cyroot.utils.itertools._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"product", (PyCFunction)__pyx_pw_6cyroot_5utils_9itertools_1product, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("product", (void (*)(void))__pyx_f_6cyroot_5utils_9itertools_product, "__Pyx_memviewslice (__Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "__pyx_fuse_0prod", (void (**)(void))&__pyx_fuse_0__pyx_f_6cyroot_3ops_10vector_ops_prod, "int (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_cyroot__utils__itertools) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cyroot.utils.itertools")) {
      if (unlikely(PyDict_SetItemString(modules, "cyroot.utils.itertools", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cyroot.utils.itertools", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cyroot.utils.itertools");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
